...
internal static class ShareXModNaturalCutPlanner
{
    public static int FindCut(Bitmap source, ShareXModV04Settings settings)
    {
        ...
        // Sample sparsely: we only need a natural-looking low-content horizontal boundary,
        // not OCR/layout reconstruction. White gaps and separators score better than text/code/images.
